...
import dev.deftu.akuma.OptionBuilder
import dev.deftu.textualizer.Language
import dev.deftu.textualizer.Localization
import net.dv8tion.jda.api.interactions.DiscordLocale

public fun <T : Language<T>> OptionBuilder.applyLocalizedNameTranslations(
...
public fun <T : Language<T>> OptionBuilder.applyLocalizedDescriptionTranslations(
    localization: Localization<T>,
    languages: Collection<T>,
    converter: (T) -> DiscordLocale,
    key: String
...
public fun <T : Language<T>> OptionBuilder.applyLocalizedTranslations(
    localization: Localization<T>,
    languages: Collection<T>,
    converter: (T) -> DiscordLocale,
    nameKey: String,
